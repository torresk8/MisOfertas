...
namespace CapaNegocio
{
    public class NegocioOferta
    {
        ...
        public bool actualizarOferta(Oferta oferta)
        {
            ...
            OracleCommand cmd = new OracleCommand("UPDATE oferta SET  nombre ='"+oferta.Nombre+"', descripcion='"+oferta.Descripcion+"', precioNormal='"+oferta.PrecioNormal+"', precioOferta='"+oferta.PrecioOfeta+"', cantidadMin='"+oferta.CantidadMin+"', cantidadMax='"+oferta.CantidadMin+"' WHERE idOferta ='"+oferta.IdOferta+"'", conn);
        ...
        public Oferta retornaOferta(string id)
        {
